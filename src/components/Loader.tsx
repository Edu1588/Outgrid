...
export function Loader({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="relative w-[300px] h-[150px] mb-8 flex justify-center items-end overflow-hidden">
          {/* Gauge Arc */}
          ...
          {/* Value Display */}
          <div className="absolute bottom-[20px] left-1/2 -translate-x-1/2 text-2xl font-light text-[#eee] z-10 text-center">
