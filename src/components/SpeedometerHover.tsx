...
export function SpeedometerHover() {
  ...
  return (
    <div 
      className="relative w-[300px] h-[165px] mb-8 flex justify-center items-end cursor-pointer group"
    ...
    >
      ...
      <div className="absolute bottom-[15px] left-1/2 w-0 h-0 z-10">
        <div 
          className="absolute -bottom-[5px] -left-[3px] w-[6px] h-[130px] bg-orange-primary origin-[50%_100%] rounded-t-md shadow-[0_0_8px_rgba(255,140,0,0.8)] transition-transform duration-[50ms] ease-linear"
