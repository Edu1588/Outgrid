            ...
            <div className="bg-[#141414] border border-white/5 rounded-3xl p-8 md:p-10 shadow-2xl relative">
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <div>
                  ...
                  <select defaultValue="" className="w-full bg-[#0A0A0A] border border-white/10 rounded-xl px-4 py-4 text-white placeholder-gray-600 focus:outline-none focus:border-orange-primary focus:ring-1 focus:ring-orange-primary transition-all font-medium appearance-none">
                ...
                <div className="pt-2">
                  <button className="w-full bg-orange-primary hover:bg-orange-600 text-white font-bold text-lg py-4 px-6 rounded-xl transition-all shadow-lg shadow-orange-primary/20 flex items-center justify-center gap-2 group">
                    Enviar aplicação
